            ...
            <>
                  <main className='relative flex flex-col justify-center gap-4 px-8 md:px-12 py-14 homeBg'>
                        <div className='flex flex-col items-center gap-6'>
                              ...
                              {/* <img className='w-48 h-48' src="../../../public/assets/images/codeCollabLogo_No_Bg.png" alt='logo' /> */}
                              ...
                              <div className='flex flex-wrap items-center justify-center gap-4'>
                                    ...
                                    <FeatureCard
                                          content={
                                                <span>
                                                      {' '}
                                                      <span className='text-purple-600'>Ask AI</span>, an AI chatbot that can help you if you get stuck in the middle of code.
                                                </span>
                                          }
                                          img={theme}
                                    />
                                    <FeatureCard
                                          content={
                                                <span>
                                                      ...
                                                      <span className='text-purple-600'>save a code snippet</span> and{' '}
                                                      <span className='text-purple-600'>share code snippet</span> to your
                                                      peers.
                                                </span>
                                          }
                                          img={Share}
